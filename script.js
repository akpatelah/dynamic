var productList = [
  ...
  var outputElement1 = document.getElementById("accessories-card");
  var html = '';
  var html1 = '';

  jsonData.forEach((item) => {
      console.log(item.isAccessory)
      if (!item.isAccessory) {
          html += "<div class='card-body'>";
          html += "<img class='data-img' src='" + item.preview + "' alt='Image'>";
          html += "<h3 class='name'>" + item.name + "</h3>";
          html += "<p class='brand'>" + item.brand + "</p>";
          html += "<h3 class='price'>" + item.price + "</h3>";
          html += "</div>";
      } else {
          html1 += "<div class='card-body'>";
          html1 += "<img class='data-img' src='" + item.preview + "' alt='Image'>";
          html1 += "<h3 class='name'>" + item.name + "</h3>";
          html1 += "<p class='brand'>" + item.brand + "</p>";
          html1 += "<h3 class='price'>" + item.price + "</h3>";
          html1 += "</div>";
      }
  })
  outputElement.innerHTML = html
  outputElement1.innerHTML = html1